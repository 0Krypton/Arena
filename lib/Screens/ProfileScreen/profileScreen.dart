...
import '../../Widgets/profileScreen/followAndFollowersContainer.dart';
...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Widget _buildHeader({height, width}) {
    return Container(
      ...
      child: Stack(
        ...
        children: [
          _buildMenuIcon(),
          _profileImageContainer(width: width, height: height),
          // _clanImageContainer(width: width, height: height),
        ],
      ),
    );
  }
  ...
  Widget _profileImageContainer({height, width}) {
    return Positioned(
  ...
  Widget _clanImageContainer({height, width}) {
    return Positioned(
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    FollowAndFollowersContainer(count: '40', name: 'following'),
                    SizedBox(width: 15),
                    ...
                    SizedBox(width: 15),
                    FollowAndFollowersContainer(
                        count: '3.6m', name: 'followers'),
                  ],
                ),
                SizedBox(height: 20),
                //TODO: refactor textStyle of all the app
                _buildSeperatorLine(width: width),
                // SizedBox(height: 20),
              ],
            ),
          ),
  ...
  Widget _buildSeperatorLine({width}) {
    return Row(
      crossAxisAlignment: CrossAxisAlignment.center,
      mainAxisAlignment: MainAxisAlignment.center,
      children: [
  ...
  Widget _userNameAndVerificationSign() {
    return Row(
      mainAxisAlignment: MainAxisAlignment.center,
      children: [
